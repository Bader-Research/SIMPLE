...
#define FTHREADED FTYPE *fth
#define MUTEX_T FTYPE
#define FTH fth
...
void FFUN(fmutexinit)(MUTEX_T *mutexkey, int *ierr, FTHREADED) {
  MAKETHREADED;
  pthread_mutex_t *mutex;
  *ierr = node_mutex_init(&mutex, NULL, TH);
  *mutexkey = (MUTEX_T)mutex;
  return;
}

void FFUN(fmutexdestroy)(MUTEX_T *mutexkey, int *ierr, FTHREADED) {
  MAKETHREADED;
  pthread_mutex_t *mutex;
...
void FFUN(fmutexlock)(MUTEX_T *mutexkey, FTHREADED) {
  MAKETHREADED;
  pthread_mutex_t *mutex;
  mutex = (pthread_mutex_t *)(*mutexkey);
...
void FFUN(fmutextrylock)(MUTEX_T *mutexkey, FTHREADED) {
  MAKETHREADED;
  pthread_mutex_t *mutex;
  mutex = (pthread_mutex_t *)(*mutexkey);
...
void FFUN(fmutexunlock)(MUTEX_T *mutexkey, FTHREADED) {
  MAKETHREADED;
  pthread_mutex_t *mutex;
  mutex = (pthread_mutex_t *)(*mutexkey);
